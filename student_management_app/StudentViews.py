    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if 'response' in answer:
                ...
                error_message = answer.get('error', 'Sorry, I could not get an answer at this moment.')
                logging.error(f"Gemini API returned an error: {error_message}")
                return JsonResponse({'answer': error_message})
        except Exception as e:
            logging.error(f"Exception in /ask/ endpoint: {str(e)}")
